<?php /* Smarty version Smarty-3.1.6, created on 2014-12-02 23:27:27
         compiled from "D:/wamp/www/blog/myblog/capsule_v1/home/Tpl\Index\index.html" */ ?>
<?php /*%%SmartyHeaderCode:15228547db441dd10a2-33007397%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '15228547db441dd10a2-33007397',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_547db44277bf5',
  'variables' => 
  array (
    'class' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_547db44277bf5')) {function content_547db44277bf5($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\wamp\\www\\blog\\myblog\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
...
?>
						<li class="index-article-list">
							<a href="#"><img src="<?php echo getheadpic($_smarty_tpl->tpl_vars['v']->value['cuid']);?>
" alt="" class="index-head-pic"></a>
							<div class="index-author">
								<a href="__APP__/article/person/uid/<?php echo $_smarty_tpl->tpl_vars['v']->value['cuid'];?>
.html"><?php echo getuname($_smarty_tpl->tpl_vars['v']->value['cuid']);?>
</a>
								<div class="index-article-title">
									<a href="__APP__/article/content/id/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
